...
public class MyObserverEvent {
    ...
    public static final String FAVORITE_QUERYLIST_FINISHED = "FAVORITE_QUERYLIST_FINISHED";//成功ArrayList<CategoryItemData> 失败null
    public static final String CATEGORY_ITEM_DATA_FINISHED = "CATEGORY_ITEM_DATA_FINISHED"; //CategoryItemData 
